...
namespace ModernClient
{
    ...
    public partial class MainWindow : Window
    {
        ...
        static private RadioButton generateButton(string input)
        {
            RadioButton printTextBlock = new RadioButton
            {
                Name = input,
                IsChecked = false
            };
            printTextBlock.SetResourceReference(RadioButton.StyleProperty, "MenuButtonTheme");
            printTextBlock.Content = input;
