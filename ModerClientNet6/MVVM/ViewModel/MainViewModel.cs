...
namespace ModernClientNet6.MVVM.ViewModel
{
    class MainViewModel : ObservableObject
    {
            ...
            set 
            {
                if (value != null)
                {
                    ...
                    if (CurrentTheme != "DarkTheme")
                    {
                        ...
                        MainWindow.StartupSettings.Theme = "LightTheme";
                    }
                    else
                    {
                        app.ChangeTheme(DarkTheme);
                        MainWindow.StartupSettings.Theme = "DarkTheme";
                    }
                }
            }
        }
        ...
        public MainViewModel()
        {
            ...
            {
                MainWindow.StartupSettings.RememberMe = false;
                MainWindow.StartupSettings.Login = null;
                MainWindow.StartupSettings.Pass = null;
                WriteJson();
                ButtonsViewModel ButtonsVM = new ButtonsViewModel(this);
                ButtonsView = new Buttons();
                ButtonsView.DataContext = ButtonsVM;
